...
def main():
    img_paths = glob.glob('input_images/*')
    for img_path in img_paths:
        generate_lgtm_img(img_path)
...
def generate_lgtm_img(img_path):
    ...
    cv2.imwrite('./result_images/' + img_name, origin_img)
